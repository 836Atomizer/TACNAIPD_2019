<div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  ...
  <input type="text" name="nombre" class="form-control" placeholder="Nombres y apellidos" autocomplete="off">
  ...
  <input type="text" name="dni" class="form-control" placeholder="Documento de identidad" autocomplete="off">
  ...
  <input type="text" name="telefono" class="form-control" placeholder="Teléfono" autocomplete="off">
